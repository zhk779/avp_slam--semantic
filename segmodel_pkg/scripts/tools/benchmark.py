...
if __name__ == '__main__':
    ...
    parser.add_argument('--model-name', type=str, default='SFNet')
    parser.add_argument('--backbone-name', type=str, default='ResNetD')
    parser.add_argument('--image-size', type=list, default=[1024, 1024])
